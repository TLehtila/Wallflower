...
#include "OpenCVTest/Public/MyGameModeBase.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMyGameModeBase() {}
// Cross Module References
	OPENCVTEST_API UClass* Z_Construct_UClass_AMyGameModeBase_NoRegister();
	OPENCVTEST_API UClass* Z_Construct_UClass_AMyGameModeBase();
...
// End Cross Module References
	...
	template<> OPENCVTEST_API UClass* StaticClass<AMyGameModeBase>()
	{
		return AMyGameModeBase::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMyGameModeBase);
	struct Z_CompiledInDeferFile_FID_OpenCVTest_Source_OpenCVTest_Public_MyGameModeBase_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OpenCVTest_Source_OpenCVTest_Public_MyGameModeBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMyGameModeBase, AMyGameModeBase::StaticClass, TEXT("AMyGameModeBase"), &Z_Registration_Info_UClass_AMyGameModeBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyGameModeBase), 1775794072U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OpenCVTest_Source_OpenCVTest_Public_MyGameModeBase_h_4102415588(TEXT("/Script/OpenCVTest"),
		Z_CompiledInDeferFile_FID_OpenCVTest_Source_OpenCVTest_Public_MyGameModeBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OpenCVTest_Source_OpenCVTest_Public_MyGameModeBase_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
